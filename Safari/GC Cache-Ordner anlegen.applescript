(**
  ...
  *)
property caches_base_path : "/Users/Kassi/Documents/Geocaching/Caches/" -- folder containing subfolders
property open_path : "/Users/Kassi/Documents/Geocaching/Caches/Offen/" -- folder containing subfolder for each cache
property d5_path : "/Users/Kassi/Documents/Geocaching/Caches/D5/" -- folder containing subfolder for each cache for D5 caches
...
tell application "Safari"
	...
	set difficulty to do JavaScript "document.evaluate(\"self::*//span[@id='ctl00_ContentBody_uxLegendScale']/img/@alt\", document.documentElement, null, XPathResult.STRING_TYPE, null).stringValue" in current_document
	if title is not "" then
		set new_folder_name to (gccode & " " & title)
		if difficulty is equal to "5 out of 5" then
			set caches_path to d5_path
		else
			set caches_path to open_path
		end if
		...
		tell application "Finder"
			...
			set new_init_filename to quoted form of (new_folder_path & "/" & title & ".rb")
...
on open_subl(caches_folder, new_filename)
	do shell script subl_path & " -a --project " & caches_base_path & "Caches.sublime-project " & new_filename
